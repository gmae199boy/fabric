...
#chaincode install
docker exec cli peer chaincode install -n donation -v 1.0 -p github.com/donation
#chaincode instatiate
docker exec cli peer chaincode instantiate -n donation -v 1.0 -C mychannel -c '{"Args":[]}' -P 'OR ("Org1MSP.member", "Org2MSP.member","Org3MSP.member")'
sleep 5
